						...
						<div className="space-y-8">
							<div className="space-y-4">
								...
								<p className="text-xl text-muted-foreground text-pretty max-w-2xl">
									Calcule os macros dos alimentos apenas com um clique.
									Fotografe, grave áudio ou digite - nós fazemos o resto.
								</p>
							</div>
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center space-y-4 mb-16">
						<h2 className="text-3xl lg:text-4xl font-bold text-foreground">
							Três formas simples de rastrear
						</h2>
						<p className="text-xl text-muted-foreground max-w-2xl mx-auto">
							Escolha a forma que mais combina com você. Nossa IA faz o trabalho
							pesado.
						</p>
					</div>
					...
					<div className="grid md:grid-cols-3 gap-8">
						<Card className="group hover:shadow-lg transition-all duration-300 border-border bg-card">
							<CardContent className="p-8 text-center space-y-4">
								...
								<h3 className="text-xl font-semibold text-card-foreground">
									Fotografe ou grave áudio
								</h3>
								<p className="text-muted-foreground">
									Nosso bot no Telegram reconhece automaticamente os alimentos e
									calcula os macros instantaneamente.
								</p>
							</CardContent>
						</Card>
						...
						<Card className="group hover:shadow-lg transition-all duration-300 border-border bg-card">
							<CardContent className="p-8 text-center space-y-4">
								...
								<p className="text-muted-foreground">
									Se não quiser usar foto ou voz, basta escrever o nome do
									alimento. Simples assim.
								</p>
							</CardContent>
						</Card>
						...
						<Card className="group hover:shadow-lg transition-all duration-300 border-border bg-card">
							<CardContent className="p-8 text-center space-y-4">
								...
								<p className="text-muted-foreground">
									O Tracking Food mostra calorias, nutrientes e um relatório
			...
			<section id="how-it-works" className="py-20 bg-muted/30">
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center space-y-4 mb-16">
						...
						<p className="text-xl text-muted-foreground max-w-2xl mx-auto">
							Em apenas 3 passos simples, você tem controle total da sua
							alimentação
						</p>
					</div>
						...
						<div className="space-y-8">
							<div className="flex items-start space-x-4">
								...
								<div>
									...
									<p className="text-muted-foreground">
										Tire uma foto, grave um áudio ou digite o que você comeu
									</p>
								</div>
							</div>
							...
							<div className="flex items-start space-x-4">
								...
								<div>
									...
									<p className="text-muted-foreground">
										Nossa inteligência artificial identifica os alimentos e
							...
							<div className="flex items-start space-x-4">
								...
								<div>
									...
									<p className="text-muted-foreground">
										Veja calorias, macros e acompanhe seu progresso diário
									</p>
								</div>
							</div>
						</div>
					...
					<div className="grid lg:grid-cols-2 gap-16 items-center">
								...
								<div className="relative">
									...
									<div className="absolute -top-4 -left-8 bg-card border border-border rounded-lg p-4 shadow-lg max-w-48">
										...
										<p className="text-xs text-muted-foreground">
											Use foto, texto ou voz, do jeito que for mais rápido para
											você.
										</p>
									</div>
									...
									<div className="absolute -bottom-4 -right-12 bg-card border border-border rounded-lg p-4 shadow-lg max-w-48">
										<div className="flex items-center space-x-2 mb-2">
											<div className="w-2 h-2 bg-primary rounded-full"></div>
											<h4 className="font-semibold text-sm text-card-foreground">
												Mais saúde, menos preocupação
											</h4>
										</div>
										<p className="text-xs text-muted-foreground">
											Mantenha o equilíbrio sem precisar decorar tabelas de
											calorias.
										</p>
									</div>
								</div>
						...
						<div className="space-y-6">
							...
							<p className="text-lg text-muted-foreground text-pretty">
								Com o Tracking Food você tem o controle da sua alimentação na
								palma da mão, sem complicação. Escolha o plano que combina com
								você e dê o primeiro passo para uma vida mais equilibrada.
							</p>
						</div>
					</div>
				</div>
								...
								<ul className="space-y-4 mb-8">
									<li className="flex items-center space-x-3">
										...
										<span className="text-card-foreground">
											1 Reconhecimento por foto por dia
										</span>
									</li>
									<li className="flex items-center space-x-3">
										<Check className="w-5 h-5 text-primary" />
									...
									<li className="flex items-center space-x-3">
										<Check className="w-5 h-5 text-primary" />
										<span className="text-card-foreground">
											Histórico de até 7 dias
										</span>
									</li>
									<li className="flex items-center space-x-3">
										<Check className="w-5 h-5 text-primary" />
										<span className="text-card-foreground">
											Acesso à comunidade Tracking Food
										</span>
									</li>
								</ul>
							...
							<CardContent className="p-8">
								...
								<ul className="space-y-4 mb-8">
									...
									<li className="flex items-center space-x-3">
										<Check className="w-5 h-5 text-primary" />
										<span className="text-card-foreground">
											Histórico completo das suas refeições
										</span>
									</li>
									<li className="flex items-center space-x-3">
										<Check className="w-5 h-5 text-primary" />
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
					<div className="space-y-8">
						...
						<p className="text-xl text-primary-foreground/80 max-w-2xl mx-auto">
							Junte-se a milhares de pessoas que já estão cuidando melhor da
							saúde com o Tracking Food
						</p>
						<Button
							size="lg"
							variant="secondary"
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="grid md:grid-cols-4 gap-8">
						<div className="space-y-4">
							...
							<p className="text-muted-foreground">
								Cuide da sua alimentação de forma inteligente e simples.
							</p>
						</div>
